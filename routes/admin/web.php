...
Route::middleware([
    ...
    ->group(function () {
        ...
        Route::name('admin.')->prefix('admin')->group(function () {
            ...
            Route::get('/home/books_chart', 'HomeController@booksChart')->name('home.books_chart');
            ...
            Route::delete('/authors/bulk_delete', 'AuthorController@bulkDelete')->name('authors.bulk_delete');
